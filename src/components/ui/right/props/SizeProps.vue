  ...
  <div class="size-props right-props">
    ...
    <div class="size-props__row">
      <div class="angle-props__row-item">
        <el-input v-model="wValue" placeholder="输入数字" :disabled="stageStore.inputDisabled" min="2" type="number"
      ...
      <div class="angle-props__row-item">
        <el-input v-model="hValue" placeholder="输入数字"
          :disabled="stageStore.inputDisabled || !stageStore.uniqSelectedElement?.heightModifyEnable" min="2"
          type="number" @change="(value) => stageStore.setElementsHeight(Number(value))">
